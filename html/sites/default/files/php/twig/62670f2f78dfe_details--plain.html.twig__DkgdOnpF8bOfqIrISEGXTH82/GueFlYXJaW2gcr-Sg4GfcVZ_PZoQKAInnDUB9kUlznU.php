...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 62) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/socialbase/templates/system/details--plain.html.twig", "/opt/bitnami/apache2/sig/html/themes/contrib/socialbase/templates/system/details--plain.html.twig");
    }
